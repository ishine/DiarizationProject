...
def splitAge_function(list_path, name1, name2, name3):
	pathname1 = os.path.join('/home/coder/suchitra/adosMod3/',name1)
	pathname2 = os.path.join('/home/coder/suchitra/adosMod3/',name2)
	pathname3 = os.path.join('/home/coder/suchitra/adosMod3/',name3)
...
with open('/home/coder/suchitra/adosMod3/ageGenderIQ.sh','r') as f:
	for word in f:
                word = word.split( )
		list1.append(word[0])
...
wavfile_path = glob.glob(os.path.join('/home/coder/suchitra/adosMod3/adosMod3_wav/','*.wav'))
rttmfile_path = glob.glob(os.path.join('/home/coder/suchitra/adosMod3/adosMod3_rttm','*.rttm'))
